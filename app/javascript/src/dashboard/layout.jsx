                    ...
                    <div className="collapse navbar-collapse ">
                      <ul className="flex-md-column flex-row navbar-nav w-100 justify-content-between navigation">
                          ...
                          <li className="nav-item link">
                              <a className="nav-link pl-0" href="/dashboard" name="standard">
                          ...
                          <li className="nav-item link">
                              <a className="nav-link pl-0" href="/report" name="report" >
                          ...
                          <li className="nav-item link">
                              <a className="nav-link pl-0" href="" onClick={handleLogout}>
