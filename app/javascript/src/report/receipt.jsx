...
class Receipt extends React.Component{
    ...
    render(){
        ...
        return(
            <React.Fragment>
                <Button variant="link" onClick={() => this.handleModalShowHide()}>
                ...
                <Modal show={this.state.showHide}>
                    ...
                    <Modal.Title>{this.props.category}
                    <p className="text-success modal-text">{this.props.amount}</p>
                    <p className="modal-date modal-text">{this.props.date}</p>
                    </Modal.Title>
                    </Modal.Header>
                    <Modal.Body><div><img alt="receipt-img" className="receipt-img" src={this.props.image}/></div></Modal.Body>
                    <Modal.Footer>
