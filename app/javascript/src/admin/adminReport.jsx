    ...
    return (
      ...
      <div className="container">
        ...
        <div className="row">
          ...
          <div className="form-group col-lg-3 col-md-5">
              <label forhtml="payID">
                <svg className="bi bi-file-check mr-1 mb-1" width="1.5em" height="1.5em" viewBox="0 0 16 16" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
              ...
              <select name='actions'  className="category-options" id="categoryID" value={this.state.actions} onChange={this.handleFilter}>
                  <option value=""></option>
