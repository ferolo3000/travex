                      ...
                      <ul className="flex-md-column flex-row navbar-nav w-100 justify-content-between navigation">
                          ...
                          <li className="nav-item link">
                              <a className="nav-link pl-0" href="#" name="standard" onClick={this.handleClick.bind(this, 'standard')}>
                                <svg className="bi bi-columns mr-3" width="1em" height="1em" viewBox="0 0 16 16" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                          ...
                          <li className="nav-item link">
                              <a className="nav-link pl-0" href="#" name="information" onClick={this.handleClick.bind(this, 'information')}>
                                ...
                                </svg> <span className="d-none d-md-inline">Information</span>
                              </a>
                          </li>
                          <li className="nav-item link">
