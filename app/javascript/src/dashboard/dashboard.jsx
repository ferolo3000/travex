    ...
    <div className="container-fluid">
      <div className="row min-vh-100 flex-column flex-md-row">
          <aside className="col-12 col-md-2 p-0 flex-shrink-1 sidebar-container ">
              <nav id="sidebar" className="navbar navbar-expand sidebar-container sidebar-navigation flex-md-column flex-row align-items-start py-2">
                  <div className="collapse navbar-collapse ">
                      <ul className="flex-md-column flex-row navbar-nav w-100 justify-content-between navigation">
                          <p className="nav-item m-2 mr-5 text-white">travex</p>
                          <li className="nav-item link">
                              <a className="nav-link pl-0" href="#"><svg className="bi bi-file-earmark-text mr-3 mb-1" width="1em" height="1em" viewBox="0 0 16 16" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                              ...
                              </svg> <span className="d-none d-md-inline">Expenses</span></a>
                          </li>
                          <li className="nav-item link">
                              <a className="nav-link pl-0" href="#"><svg className="bi bi-clipboard-data mr-3 mb-1" width="1em" height="1em" viewBox="0 0 16 16" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                              ...
                              </svg> <span className="d-none d-md-inline">Stats</span></a>
                          </li>
                          <li className="nav-item link">
                              <a className="nav-link pl-0" href="#"><svg className="bi bi-layout-text-window-reverse mr-3 mb-1" width="1em" height="1em" viewBox="0 0 16 16" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                              ...
                              </svg> <span className="d-none d-md-inline">Report</span></a>
                          </li>
                          <li className="nav-item link">
                              <a className="nav-link pl-0" href="#"><svg className="bi bi-shield-lock mr-3 mb-1" width="1em" height="1em" viewBox="0 0 16 16" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                              ...
                              </svg> <span className="d-none d-md-inline">Privacy & Security</span></a>
                          </li>
                          <li className="nav-item link">
                              <a className="nav-link pl-0" href="#"><svg className="bi bi-box-arrow-left mr-3 mb-1" width="1em" height="1em" viewBox="0 0 16 16" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                              ...
                              </svg> <span className="d-none d-md-inline">Log Out</span></a>
                          </li>
                      </ul>
                  </div>
              </nav>
